    ...
    <div class="row">
        <div class="col">
            <div class="card shadow">
                ...
                @endif
                {!!  Form::model($orders, ['url' => route('diver.update',$orders->id_orders),'method' => 'put'])!!}
            ...
            <div class="table-responsive">
                <table class="table align-items-center table-flush">
                    ...
                    <tr>
                        ...
                        <td>{{$orders->employee_EmpId}}</td>
                        <td>{{$orders->send_has_orders_status_ID}}</td>
                        ...
                        <td> <select name="send_has_orders_status_ID" id="send_has_orders_status_ID">
                                ...
                                <option value="ส่งผ้าสำเร็จ">ส่งผ้าสำเร็จ</option>
                            </select> </td>
                        <td>
